...
export const PuzzleIcon: React.FC = () => <div className="text-3xl">🧩</div>;
export const RunningIcon: React.FC = () => <div className="text-3xl">🏃‍♀️</div>;
export const GamepadIcon: React.FC = () => <div className="text-3xl">🎮</div>;
export const LightbulbIcon: React.FC = () => <div className="text-3xl">💡</div>;
export const CalendarIcon: React.FC = () => <div className="text-3xl">🗓️</div>;
export const BrainIcon: React.FC = () => <div className="text-3xl">🧠</div>;
